 ...
 * @author lixuy
 */
public class ComposeMessageAssociationJPanel extends javax.swing.JPanel {

    private UserAccount userAccount;
    private EcoSystem system;
    /**
     * Creates new form ComposeMessageJPanel
     */
    public ComposeMessageAssociationJPanel(UserAccount userAccount, EcoSystem system) {
       initComponents();
    ...
    private void initClubjComboBox() {
     ...
     private void initOrganizationjComboBox(String clubName) {
         ...
         if(clubName.equals("N/A"))
         {
           organizationjComboBox.addItem("Referee Organization");      
    ...
    private void initPersonneljComboBox(String clubName,String organizationName) {
        ...
        personneljComboBox.removeAllItems();
         ...
         if(organizationName.equals("Referee Organization"))
         {
             Organization organization = null;
             for(Organization o: system.getOrganizationDirectory().getOrganizationList())
             {
               if(o.getName().equals("Referee Organization"))
               {
                organization = o;
                break;        
               }
