 ...
 * @author lixuy
 */
public class ManageSquadListJPanel extends javax.swing.JPanel {

    private JPanel container;
    private Club club;
    private LeagueDirectory leagueDirectory;
    /**
     * Creates new form ManagerSquadListJPanel
     */

    ManageSquadListJPanel(JPanel container, Club club, LeagueDirectory leagueDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "League", "MatchID", "Match Info", "Location", "Time", "Squad List Finished"
            }
        ) {
    ...
    private void provideBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_provideBtnActionPerformed
        ...
        if(selectedrow >= 0)
        {
            ...
            {
             if(o.getName().equals("First Team"))
             {
              organization = o;
              break;
             }
            ...
            if(judge.equals("No"))
            {    
            ProvideSquadListJPanel panel = new ProvideSquadListJPanel(container,organization, match, clubBelong, league);
            JScrollPane jscrollPane1 =new JScrollPane(panel);
            container.add("ProvideSquadListJPanel",jscrollPane1);
            CardLayout layout = (CardLayout) container.getLayout();
            layout.next(container);
            }
            else
            {
             JOptionPane.showMessageDialog(null,"You have already provided the squad list!","Warning", JOptionPane.WARNING_MESSAGE);
            }
        }
        else
        {
        ...
        {   
            ...
            if(clubBelong.equals("club1"))
            {
              if(match.isClub1PlayerBigListProvided())
              {
                ...
                ViewSquadListJPanel panel = new ViewSquadListJPanel(container, match, clubBelong);              
                container.add("ViewSquadListJPanel",panel);
                CardLayout layout = (CardLayout) container.getLayout();
                layout.next(container);
              }
              else
              {
               JOptionPane.showMessageDialog(null,"Squad List List doesn't exist!","Warning", JOptionPane.WARNING_MESSAGE);
              }
            }
            ...
            if(clubBelong.equals("club2"))
            {
              ...
              {
               JOptionPane.showMessageDialog(null,"SquadList List doesn't exist!","Warning", JOptionPane.WARNING_MESSAGE);
              }
            }         
        }
        else
