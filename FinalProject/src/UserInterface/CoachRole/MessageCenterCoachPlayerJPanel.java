 ...
 * @author lixuy
 */
public class MessageCenterCoachPlayerJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form MessageCenterCoachPlayerJPanel
     */
    public MessageCenterCoachPlayerJPanel(JPanel container, UserAccount userAccount, Club club, EcoSystem system) {
        initComponents();
    ...
    private void composeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_composeBtnActionPerformed
        ...
        ComposeMessageCoachPlayerJPanel panel = new ComposeMessageCoachPlayerJPanel(userAccount,club,system);
